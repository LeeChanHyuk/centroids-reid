...
class CTLModel(ModelBase):
    ...
    def training_step(self, batch, batch_idx, optimizer_idx=None): # forward?
        opt, opt_center = self.optimizers(use_pl_optimizer=True) # Optimizer

        # Gradual warmup for learning rate
